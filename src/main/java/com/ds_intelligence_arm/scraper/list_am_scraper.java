...
public class list_am_scraper {
    
    private static final Gson gson = new Gson();
    String resourcePath = Paths.get(System.getProperty("user.dir"), "src", "resources", "list_am.json").toString();

     public static void main(String[] args) throws InterruptedException {
         List<Map<String, String>> scrapedDataList = new ArrayList<>();

         // Scrape and accumulate data in the list
         for (int i = 21918964; i > 21918934; i--) {
             Thread.sleep(5000);
    ...
    private static Map<String, String> scrapeData(int id) {
        try {
            String url = String.format("https://www.list.am/item/%s", id);
